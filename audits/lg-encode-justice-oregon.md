...
Comparison: EFF identifies Oregon as one of the Encode Justice chapters; "Oregon state chapter of Encode Justice" matches.
...
Source: https://www.eff.org/deeplinks/2024/06/encode-justice-nc-movement-safe-equitable-ai
Source content: "Currently three local chapters of Encode Justice have joined the EFA: Encode Justice North Carolina, Oregon, and Georgia."
Comparison: Exact match — three chapters, named the same three.
Decision: corroborated
...
## Claim 9: "[founded in 2022]" (chapter founding year per LinkedIn)

Source: https://www.linkedin.com/company/encode-justice-oregon-chapter
Source content: "Founded: 2022"
Comparison: Year matches verbatim.
Decision: corroborated
...
Source: https://www.linkedin.com/company/encode-justice-oregon-chapter
Source content: "Oregon's ONLY fully youth-led group mobilizing for equitable & ethical AI and ML legislation & education."
...
## Claim 16: "advocating for standardised computer-science course implementation across the district"

Source: https://www.linkedin.com/in/alenapeethala1/
Source content: LinkedIn returned HTTP 999 in this audit pass. No canonical source consulted in this session confirms the CS-course-advocacy claim.
Comparison: Cannot be checked against a canonical source in this session.
Decision: uncorroborated
...
## Claim 18: "led a team of students from across Oregon on policy drafting, educational slideshows, and outreach to teachers and community leaders, with human-centred AI advocacy as the framing"

Source: https://www.linkedin.com/in/alenapeethala1/
Source content: LinkedIn returned HTTP 999 in this audit pass. No canonical source consulted in this session confirms the specific activity-thread descriptors.
Comparison: Cannot be checked against a canonical source in this session.
Decision: uncorroborated
...
## Claim 21: "the corpus's first Pacific-Northwest local-group entry... and... the corpus's first Portland-metro local-group anchor"

Source: corpus state (product/entities/local-groups/)
Source content: A grep over `product/entities/local-groups/*.md` for Oregon / Portland / Seattle / Washington-state / Pacific-Northwest / Idaho location markers returns no matches outside this entity itself.
Comparison: No other Pacific-Northwest or Portland-metro local-group entry exists in the corpus as of audit; "first" claims are accurate against current corpus state.
Decision: corroborated
