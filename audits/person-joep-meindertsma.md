...
Comparison: Body claim matches source — Wikipedia names Meindertsma as the establisher/founder; pauseai.info/about lists his current role as "Founder PauseAI Global, Board Chair." Named-entity definitional fact (founder/official role) — Wikipedia-alone sufficient per source rule, and a second canonical source (pauseai.info, primary) also confirms.
Decision: corroborated

## Claim 2: "which he convened in Utrecht, Netherlands in May 2023"

Source: https://en.wikipedia.org/wiki/PauseAI
Source content: "Formation: May 2023" / "Founded at: Utrecht, Netherlands" / "established in Utrecht in May 2023 by software entrepreneur Joep Meindertsma"
Comparison: Body's "Utrecht, Netherlands in May 2023" matches Wikipedia exactly. Date-of-public-event and named-entity-definitional-fact — Wikipedia-alone sufficient.
Decision: corroborated

## Claim 3: "from his prior role as a software-company CEO"

Source: https://en.wikipedia.org/wiki/PauseAI
Source content: "He founded PauseAI in May 2023, putting his job as the CEO of a software firm on hold."
Comparison: Body's "prior role as a software-company CEO" matches Wikipedia's "CEO of a software firm" within paraphrase tolerance.
Decision: corroborated
