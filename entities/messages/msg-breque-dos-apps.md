---
id: msg-breque-dos-apps
type: message
name: "Breque dos Apps"
status: active
confidence: high
tags: [brazil, latin-america, south-america, gig-economy, platform-workers, food-delivery, delivery-workers, algorithmic-pay, worker-organising, ai-and-labour, strike, slogan, counter-narrative, covid-19, informal-workers, entregadores-antifascistas, whatsapp-organising, international-coordination, yonoreparto, algorithmic-control, algorithmic-management, robo-management, worker-surveillance]
created: 2026-06-04
last_updated: 2026-06-04
origin: |
  The movement name and counter-narrative framing through which Brazilian app-delivery workers organized a series of national strikes against algorithmic pay-setting by food-delivery platforms — primarily iFood, Uber Eats, and Rappi — beginning with the first Breque dos Apps on 1 July 2020. The name is a bilingual pun: "breque" is a Portuguesized borrowing of the English "brake", and its phonetic similarity to "greve" (strike) makes the phrase simultaneously "brake the apps" and "strike against the apps". The movement's origin is the algorithmic deactivation of Paulo Roberto da Silva Lima (known as "Paulo Galo") from Uber Eats on 22 March 2020: his bicycle tyre went flat mid-delivery; he notified Uber Eats and was told it was fine; the next morning he was locked out of the platform with no explanation or appeal process. His viral video denouncing the deactivation became the founding act of the Entregadores Antifascistas (Anti-Fascist Delivery Workers) collective, created in late March and early April 2020, which grew to approximately forty active members across eleven Brazilian states by the time of the July 2020 strikes. The movement's central slogans — "Não somos heróis, somos trabalhadores" ("We are not heroes, we are workers") and "Não somos empreendedores" ("We are not entrepreneurs") — crystallised two counter-narratives simultaneously: the first refusing the pandemic-era cultural flattery that called delivery workers heroes while their earnings fell; the second refusing the legal classification platforms used to deny employment rights by channelling all labour-direction through the algorithm. The July 2020 strike trended as the number-one topic on Brazilian Twitter for five hours, generating an estimated 432,430 tweets; the parallel Latin American action coordinated under #YoNoReparto connected workers in Argentina, Mexico, Peru, Guatemala, Chile, Costa Rica, and Ecuador to the Brazilian action.
originating_person:
originating_org:
propagated_by_orgs: []
related_messages:
...
sources:
  - url: https://www.aljazeera.com/economy/2020/7/1/brazil-deliverymen-for-uber-other-apps-protest-amid-pandemic
    last_checked: 2026-06-04
    note: 'Al Jazeera, 1 July 2020 — contemporaneous news coverage of the first national Breque dos Apps; primary source for the labour prosecutor Tatiana Simonetti quote ("An algorithm determines everything for them: the value of the work, the duration of their work, even the route they should take, and if you don''t accept, there are penalties") and for the São Paulo street-action reporting'
