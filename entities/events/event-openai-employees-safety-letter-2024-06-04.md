---
id: event-openai-employees-safety-letter-2024-06-04
type: event
name: '"A Right to Warn about Advanced Artificial Intelligence" — current and former AI lab employee open letter (4 June 2024)'
status: historical
confidence: high
...
participating_orgs: []
participating_people: [person-daniel-kokotajlo, person-geoffrey-hinton, person-neel-nanda, person-yoshua-bengio]
related_events:
  - event-timnit-gebru-firing-google-2020-12-02
sources:
  - url: https://righttowarn.ai/
    last_checked: 2026-06-10
    note: 'Original text of "A Right to Warn about Advanced Artificial Intelligence" (4 June 2024) — primary source for the letter''s four principles, the named signatories (Hilton, Kokotajlo, Kumar, Nanda, Saunders, Wainwright, Ziegler; four anonymous current OpenAI employees; two anonymous former OpenAI employees), and the three cited AI risk categories'
  - url: https://www.cnbc.com/2024/06/04/openai-open-ai-risks-lack-of-oversight.html
    last_checked: 2026-06-10
    note: 'CNBC (4 June 2024) — primary source for signatories'' affiliations at time of signing and OpenAI''s spokesperson statement ("proud of our track record providing the most capable and safest AI systems")'
  - url: https://www.cnbc.com/2024/05/24/openai-sends-internal-memo-releasing-former-employees-from-non-disparagement-agreements-sam-altman.html
    last_checked: 2026-06-10
    note: 'CNBC (24 May 2024) — primary source for OpenAI''s internal memo releasing former employees from nondisparagement obligations and Sam Altman''s acknowledgment that the equity-clawback threat had been a mistake'
  - url: https://fortune.com/2024/05/17/openai-researcher-resigns-safety/
    last_checked: 2026-06-10
    note: 'Fortune (17 May 2024) — primary source for Jan Leike''s resignation as head of OpenAI''s superalignment team and his X-thread statement that "safety culture and processes have taken a backseat to shiny products"'
  - url: https://siliconangle.com/2024/06/04/public-letter-former-openai-researchers-urge-increased-transparency-ai-risks/
    last_checked: 2026-06-10
    note: 'SiliconAngle (4 June 2024) — secondary source summarising the letter and signatories; cross-check for the three AI risk categories and the letter''s framing of the whistleblower-protection demands'
---

# "A Right to Warn about Advanced Artificial Intelligence" — current and former AI lab employee open letter (4 June 2024)

On 4 June 2024, current and former employees of OpenAI and Google DeepMind published ["A Right to Warn about Advanced Artificial Intelligence"](https://righttowarn.ai/) — an open letter demanding structural whistleblower protections inside frontier-AI companies. Seven researchers signed by name: Jacob Hilton, [Daniel Kokotajlo](../persons/person-daniel-kokotajlo.md), Ramana Kumar, [Neel Nanda](../persons/person-neel-nanda.md), William Saunders, Carroll Wainwright, and Daniel Ziegler. Six more signed anonymously — four current and two former OpenAI employees. The letter also carried the explicit endorsement of Turing Award winners [Geoffrey Hinton](../persons/person-geoffrey-hinton.md) and [Yoshua Bengio](../persons/person-yoshua-bengio.md) and computer scientist Stuart Russell. It was the first time current employees of OpenAI had publicly and collectively raised concerns about the company's safety culture in a structured advocacy document, even if only anonymously, and it arrived ten days after Sam Altman had been forced by public pressure to retract the nondisparagement agreements that had been its immediate catalyst.

## Background: the superalignment departures and the NDA controversy

The letter emerged from a cascade of events at OpenAI in May 2024 that made the company's internal safety culture unusually visible. On 15 May 2024, Ilya Sutskever — OpenAI's co-founder and chief scientist, and one of the two heads of its Superalignment team — announced he was leaving. Two days later, on 17 May 2024, [Jan Leike](../persons/person-jan-leike.md), the other head of the Superalignment team, resigned and published a [thread on X](https://fortune.com/2024/05/17/openai-researcher-resigns-safety/) that stated: "Over the past years, safety culture and processes have taken a backseat to shiny products." Leike wrote that he had "reached a breaking point" and that the company should be spending far more bandwidth preparing for the next generation of models. OpenAI confirmed that it had dissolved the Superalignment team, integrating its members across other research groups.

In the weeks that followed, reporting in major outlets revealed that OpenAI had been requiring departing employees to sign unusually broad nondisparagement agreements — agreements whose language threatened to claw back vested equity if the former employee publicly "disparaged" the company, a provision understood to cover statements about safety concerns drawn from nonconfidential public information. The controversy was acute enough that on [24 May 2024, Sam Altman sent an internal memo](https://www.cnbc.com/2024/05/24/openai-sends-internal-memo-releasing-former-employees-from-non-disparagement-agreements-sam-altman.html) stating that the nondisparagement clauses would be removed from standard departure paperwork, that former employees would be released from existing obligations, and acknowledging that the equity-clawback language had been a mistake. The letter followed ten days later.
