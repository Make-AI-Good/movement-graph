---
id: strat-mass-participation-in-agency-rulemaking-comments
type: strategy
name: Mass participation in agency AI rulemaking comment periods
status: active
confidence: high
tags: [rulemaking, notice-and-comment, ftc, ostp, eu-commission, administrative-law, mass-comments, docketed-record, comment-mobilisation, apa]
created: 2026-07-15
...
# Mass participation in agency AI rulemaking comment periods
...
This strategy differs from [strat-coalition-lobbying-of-binding-regional-regulation](strat-coalition-lobbying-of-binding-regional-regulation.md) by *branch of government* — this one targets executive-branch agencies through their statutory rule-making, that one targets legislatures through their statutory rule-making. It differs from [strat-participatory-deliberation-as-policy-input](strat-participatory-deliberation-as-policy-input.md) by *venue construction* — deliberation builds a citizens' assembly the organiser convenes, comment-mobilisation feeds an official docket the agency runs. Movements that run both arms give the same coalition two distinct entry points into the administrative-state policy pipeline on the same technology.
