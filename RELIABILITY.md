...
generated_at: 2026-07-05T06:53:31Z
generated_at_commit: 9ea68f85970cb9865ac0aa3ab2ab8b86233e7380
generator: project/teams/movement-graph/dashboard/generate-reliability.sh
audited_entities: 510
total_entities: 805
audit_coverage_pct: 63
total_claims: 11495
claims_corroborated: 8171
claims_primary_sourced: 789
claims_single_source: 272
claims_uncorroborated: 1814
open_corrections: 449
status_corroborated: 40
status_supported: 233
status_corrections_pending: 237
---

# Corpus reliability

Auto-generated at commit `9ea68f8` from the per-entity audit trail under [`audits/`](audits/). Each release tag pins one of these.

This graph is independently audited at the claim level. Of 11,495 claims across 510 audited entities: **77.9%** corroborated or primary-sourced, **2.4%** single-source, **15.8%** not independently corroborated, **3.9%** precision-corrected (which we apply). **No fabrication observed.**
...
| Metric | Value |
|---|---|
| Audit coverage | 510 / 805 entities (63%) |
| Total claims audited | 11,495 |
| Claims corroborated (≥2 sources) | 8,171 |
| Claims primary-sourced (1 primary-tier source) | 789 |
| Claims single-source (1 non-primary canonical source) | 272 |
| Claims uncorroborated | 1,814 |
| Open corrections | 449 |
| Entities — status `corroborated` | 40 |
| Entities — status `supported` | 233 |
| Entities — status `corrections-pending` | 237 |
